...
# =============================================================================
# COMBINED VISUALIZATION: ELBOW PLOT AND METRICS ON A SINGLE PAGE
# =============================================================================
fig = plt.figure(figsize=(18, 16))
gs = gridspec.GridSpec(3, 2, height_ratios=[1, 1, 1])

# Subplot 1: Elbow Plot spanning the first row (both columns)
ax0 = fig.add_subplot(gs[0, :])
ax0.plot(list(k_range), inertias, marker='o')
ax0.set_xlabel("Number of Clusters (k)")
ax0.set_ylabel("Inertia")
ax0.set_title("Elbow Method for Optimal k")

# Subplot 2: Total Staffing Cost per Cluster (Top Left of metrics)
...
# Subplot 3: Average Resolution Days per Cluster (Top Right of metrics)
...
# Subplot 4: Resolution Percentage with Target Flag (Bottom Left of metrics)
...
# Subplot 5: On-site vs. Virtual Claim Handling per Cluster (Bottom Right of metrics)
...
def update_claims(new_claims_df):
    ...
    # (Optional) Update drive times if new geographic data suggests different travel times
    # For simplicity, we assume drive times remain constant.
